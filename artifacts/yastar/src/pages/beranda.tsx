...
const MODULE_CARDS: ModuleCard[] = [
  ...
  {
    id: 'bundling',
    title: 'Bundling & Diskon Promo',
    description: 'Hitung kelayakan paket combo, harga promo, sisa margin, dan target unit terjual.',
  ...
  {
    id: 'komisi',
    title: 'Komisi Staf Berjenjang',
    icon: <Users className="h-5 w-5" />,
    description: 'Simulasikan komisi bertingkat berdasarkan target jumlah klien untuk memotivasi staf.',
    badge: 'Starter+',
    accessKey: 'bep_usaha',
  },
  {
    id: 'benchmark',
    title: 'Benchmark Industri Jasa',
    description: 'Bandingkan margin dan rasio gaji usaha Anda dengan rata-rata industri di Indonesia.',
  ...
  {
    id: 'ai-advisor',
    title: 'AI Business Advisor (Gemini AI)',
    description: 'Analisis naratif cerdas, saran strategis, dan draf promosi WhatsApp & IG otomatis.',
...
export default function BerandaPage({ account }: BerandaPageProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      {account && <RenewalBanner account={account} />}
