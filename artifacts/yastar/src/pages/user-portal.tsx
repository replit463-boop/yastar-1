...
import BundlingCalculatorPage from '@/pages/bundling-calculator';
import BenchmarkPage from '@/pages/benchmark-page';
import KomisiCalculatorPage from '@/pages/komisi-calculator';
  ...
  return (
    <PortalLayout activeModule={module} account={account}>
      <div className="p-6 max-w-5xl mx-auto">
        ...
        {module === 'bundling' && (
          <BundlingCalculatorPage canSave={canSave} onScenarioSaved={onScenarioSaved} />
        )}
        {module === 'komisi' && (
          <KomisiCalculatorPage canSave={canSave} onScenarioSaved={onScenarioSaved} />
        )}
        {module === 'benchmark' && (
          <BenchmarkPage />
        )}
